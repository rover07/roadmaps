...
###  R - good tool for visualization and statistical analysis
  ...
  - [R For Data Science Full Course -Youtube(Simplilearn)](https://youtu.be/iROHLA_TXQM)
  - [R programming language Introduction -GFG(GeeksForGeeks)](https://www.geeksforgeeks.org/r-programming-language-introduction/)
  - [R programming Tutorial -W3schools(W3schools.com)](https://www.w3schools.com/r/)
  - [R programming language -R for datascience (Hadley Wickham)](https://r4ds.had.co.nz/)

###  Python

  - [Python Tutorial for Beginners -Youtube(TechWorld with Nana)](https://youtu.be/t8pPdKYpowI)
  - [Python Tutorial - Python Full Course for Beginners - Youtube(Programming with Mosh)](https://youtu.be/_uQrJ0TkZlc)
  - [Harvard CS50’s Introduction to Programming with Python - Youtube(freeCodeCamp.org)](https://youtu.be/nLRL_NcnK-4)
  - [Python for Beginners - Youtube(freeCodeCamp.org)](https://youtu.be/eWRfhZUzrAc)
  - [Python programming language -W3Schools(W3Schools.com)](https://www.w3schools.com/python/python_intro.asp)
  - [Python programming language -GFG(GeeksForGeeks)](https://www.geeksforgeeks.org/python-programming-language/)

###  SQL

  - [SQL Tutorial - Full Course - Youtube(freeCodeCamp.org)](https://youtu.be/HXV3zeQKqGY)
  - [SQL Tutorial for Beginners -Youtube(Programming With Mosh)](https://youtu.be/7S_tz1z_5bA)
...
- [Best practices with pandas -Youtube(Data School)](https://youtube.com/playlist?list=PL5-da3qGB5IBITZj_dYSFqnd_15JgqwA6)
- [Pandas -Kaggle(Kaggle.com)](https://www.kaggle.com/learn/pandas)
- [Pandas documentation -Pandas.pydata(Pandas.pydata.org)](https://pandas.pydata.org/pandas-docs/version/0.15/tutorials.html)

###  Numpy

- [Python NumPy Tutorial for Beginners -Youtube(freeCodeCamp.org)](https://youtu.be/QUT1VHiLmmI)
- [Numpy Full Course -Youtube(Simplilearn)](https://youtu.be/j31ah5Qa4QI)
...
- [Data Cleaning course -datacamp(app.datacamp.com)](https://app.datacamp.com/learn/courses/cleaning-data-in-python)
- [Data cleaning course -kaggle(kaggle.com)](https://www.kaggle.com/learn/data-cleaning)
- [Data cleaning documentation -kaggle(Ashish Gaurav)](https://www.kaggle.com/ashishg21/data-cleaning-and-some-analysis-shoe-prices)

###  Data Visualization

- [Data Visualization full playlist -Youtube(Corey Schafer)](https://www.youtube.com/watch?v=UO98lJQ3QGI&list=PL-osiE80TeTvipOqomVEeZ1HRrcEvtZB_)
- [Data Visualization tutorial series -Youtube(sentdex)](https://www.youtube.com/watch?v=q7Bo_J8x_dw&list=PLQVvvaa0QuDfefDfXb9Yf0la1fPDKluPF)
...
- [EDA and Feature Engineering -Youtube(Krish Naik)](https://youtu.be/fHFOANOHwh8)
- [EDA in Python -Youtube(Simplilearn)](https://youtu.be/MoM6mighOJM)
...
- [ML full course playlist -Youtube(Andrew Ng)](https://youtube.com/playlist?list=PLoROMvodv4rMiGQp3WXShtMGgzqpfVfbU)
- [ML full playslist -Youtube(KunalKushwaha)](https://youtube.com/playlist?list=PLyzHIYrZBplo3K0dNUqppd2ynnoZPD6N1)
- [ML full course video -Youtube(Simplilearn)](https://www.youtube.com/live/lTzHlU3OrXs?feature=share)
...
- [Power BI full course tutorial -Youtube(Learnit Training)](https://youtu.be/e6QD8lP-m6E)
...
- [Tableau Introduction -datacamp](https://learn.datacamp.com/courses/introduction-to-tableau)
...
- [Flask tutorial -towardsdatascience](https://towardsdatascience.com/deploying-a-deep-learning-model-using-flask-3ec166ef59fb)
- [Flask tutorial -GFG(geeksforgeeks)](https://www.geeksforgeeks.org/flask-creating-first-simple-application/)
- [How to Deploy a Machine Learning Model to Google Cloud -Youtube(Daniel Bourke)](https://www.youtube.com/watch?v=fw6NMQrYc6w)
